...
class Game(simpleGE.Scene):
    ...
    def __init__(self):
        ...
        self.restartButton.text = "Restart(Blue)"
        ...
        self.quitButton.text = "Quit(White)"
        ...
        self.startButton.textLines =  ["Don't let earth get hit 3 times",
                          ...
                          "Use joystick to move, and RED to shoot",
                          "Push up on joystick to start! Have fun!"]
    ...
    def update(self):
        ...
        if self.quitButton.clicked or self.isKeyPressed(pygame.K_e):
            
            self.stop()
        
        if self.restartButton.clicked or self.isKeyPressed(pygame.K_q):
        ...
        if self.startButton.clicked or self.isKeyPressed(pygame.K_w):
